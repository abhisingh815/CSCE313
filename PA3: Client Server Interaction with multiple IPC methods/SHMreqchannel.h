...
class SHMQ {
	private:
		char* segment;
		sem_t* sd; //sender done semaphore
		sem_t* rd; //reciever done semaphore
		string name;
		int len;
...
class SHMRequestChannel: public RequestChannel{ //SHMclass publicly derives request channel class 
	private:
		SHMQ* shmq1;
		SHMQ* shmq2;
		int len;
