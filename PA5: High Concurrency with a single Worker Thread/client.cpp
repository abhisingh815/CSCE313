...
void file_thread_function(string filename, FIFORequestChannel* wchan, BoundedBuffer* requestBuffer, int mb){
    //create the file
...
void event_polling_function (FIFORequestChannel** wchans, BoundedBuffer* requestBuffer, BoundedBuffer* responseBuffer, HistogramCollection* hc, int n, int p, int w, int mb){    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //event poller thread 
    char buf [1024];
    char recvbuf [mb];
...
int main(int argc, char *argv[]){
    ...
    if (!isfiletransfer) {
        ...
        thread filethread (file_thread_function, filename, chan, &requestBuffer, m);
